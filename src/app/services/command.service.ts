...
import { getDefaultEngineSettings, IPlayerTeam } from '../components/chess-board/helpers/PlayerTeamHelper';
...
export class CommandService {
  ...
  swapAllTeamsAndRematch() {
    ...
    const currentMatchCount = this.sharedDataService.getSharedDataSync().matchCount;
